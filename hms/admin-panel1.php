...
function generate_bill() {
    ...
    if (!isset($_GET['ID'])) {
        return "Appointment ID not provided.";
    }

    $appointmentID = $_GET['ID']; // Retrieve Appointment ID from the URL
    $output = '';

    // Query to fetch the required details for the bill
    $query = mysqli_query($con, "
        SELECT 
            p.pid, p.ID, p.fname, p.lname, p.doctor, 
            p.appdate, p.apptime, p.disease, p.allergy, 
    ...
    if (mysqli_num_rows($query) == 0) {
        return "No matching records found for the given Appointment ID.";
    }

    // Build the output for the PDF
    while ($row = mysqli_fetch_array($query)) {
        $output .= '
            ...
            <label> Fees : </label>' . $row["docFees"] . '<br/>
        ';
    }
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Starlight Hospitals</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-star" aria-hidden="true"></i> Starlight Hospital </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left,  #025644, #05cea3);
}
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list"  role="tab" data-toggle="list" aria-controls="home">Billing Generation</a>
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-6">
                ...
                <div class="col-sm-6" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Bill Generation</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                    ...
                    $query = "select doctor,pid,ID,appdate,apptime,disease,allergy,prescription from prestb;";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <a href="admin-panel1.php?ID=<?php echo $row['ID']?>">
                              <input type ="hidden" name="ID" value="<?php echo $row['ID']?>"/>
                              <input type = "submit" onclick="alert('Billing Generated Successfully');" name ="generate_bill" class = "btn btn-success" value="Generate Bill"/>
                              </a>
                              </td>
                              </form>
