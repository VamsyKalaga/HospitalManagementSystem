...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-star" aria-hidden="true"></i> Starligth Hospital </a>
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="row">
                  ...
                  <textarea id="prescription" cols="75" rows ="7" name="prescription" required></textarea>
                  </div><br><br><br>
